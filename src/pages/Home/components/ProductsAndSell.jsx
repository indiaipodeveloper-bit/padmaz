...
export default function ProductionAndSalesFull() {
  ...
  // Parent variant for the two-column block (left & right cards)
  const parentTwoCol = {
    hidden: {},
    visible: {
      transition: {
        staggerChildren: 0.20, // slower stagger
      },
    },
  };

  // Left -> Right (slower, softer)
  const leftToRight = {
  ...
  // Heading animation (slower fade + slide up)
  ...
  // Parent props helper (respect reduced motion)
  ...
  return (
    <div className="py-20 px-4 max-w-7xl mx-auto">
      ...
      {/* TWO-COLUMN BLOCK: left = production (comes left->right), right = sales (comes right->left) */}
